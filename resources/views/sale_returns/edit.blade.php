        ...
        <div class="bg-white border border-gray-200 rounded-xl overflow-hidden">
            ...
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-gray-50/60">
                <div>
                    ...
                    <p class="text-xs text-gray-400 mt-0.5">Update the return information below.</p>
                </div>
            ...
            <form method="POST" action="{{ route('sale-returns.update', $saleReturn) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="px-6 py-6 space-y-4">
                    @include('sale_returns._form', ['saleReturn' => $saleReturn])
                </div>
