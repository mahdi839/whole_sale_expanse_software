<x-app-layout>
    <x-slot name="header">Edit Return</x-slot>
    ...
    <div class="space-y-4">
        ...
        <div class="bg-white border border-gray-200 rounded-xl overflow-hidden">
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-gray-50/60">
                <div>
                    <h2 class="text-sm font-semibold text-gray-800">Edit Return</h2>
                    <p class="text-xs text-gray-400 mt-0.5">
                        Update the return information below.
                    </p>
                </div>
            ...
            <form method="POST" action="{{ route('sale-returns.update', $saleReturn) }}">
                @csrf
                @method('PUT')
