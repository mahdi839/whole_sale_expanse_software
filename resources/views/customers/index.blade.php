<x-app-layout>
    ...
    <div class="space-y-4">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            ...
            {{-- Search --}}
            <form method="GET" action="{{ route('customers.index') }}" class="flex items-center gap-2 w-full sm:max-w-md">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
            ...
            <div class="bg-white border border-gray-200 rounded-xl p-4">
                ...
                <p class="text-2xl font-semibold text-gray-800">৳{{ number_format($totalSale, 2) }}</p>
            </div>
            <div class="bg-white border border-gray-200 rounded-xl p-4">
                <p class="text-xs text-gray-500 mb-1">Total Paid</p>
                <p class="text-2xl font-semibold text-green-600">৳{{ number_format($totalPaid, 2) }}</p>
            </div>
            <div class="bg-white border border-gray-200 rounded-xl p-4">
                <p class="text-xs text-gray-500 mb-1">Total Due</p>
                <p class="text-2xl font-semibold {{ $totalDue > 0 ? 'text-red-600' : 'text-gray-400' }}">৳{{ number_format($totalDue, 2) }}</p>
            </div>
        </div>
                            ...
                            <tr>
                                <td colspan="7" class="px-5 py-16 text-center">
                                    <div class="flex flex-col items-center gap-3 text-gray-400">
                                        <svg class="w-10 h-10" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                                        <p class="text-sm">
                                            @if($search)
