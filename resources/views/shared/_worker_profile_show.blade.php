<x-app-layout>
    ...
    <div class="space-y-4">
        <div class="flex items-center justify-between gap-3">
            ...
            <a href="{{ route($routeBase.'.export.pdf', $worker) }}" class="px-4 py-2 text-sm bg-red-50 border border-red-200 text-red-700 rounded-lg">PDF Profile, Work Logs & Transactions</a>
        </div>
